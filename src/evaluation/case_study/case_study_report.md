...
This report presents detailed analysis of selected prediction cases.
Cases are selected from four categories:

- **True Positives (TP)**: Correctly predicted to stay open
- **True Negatives (TN)**: Correctly predicted to close
- **False Positives (FP)**: Predicted to stay open but closed
- **False Negatives (FN)**: Predicted to close but stayed open
...
*Report generated by CS 412 Research Project case study pipeline*